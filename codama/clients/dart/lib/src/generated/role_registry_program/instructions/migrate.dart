...
import '../programs/role_registry_program.dart' show roleRegistryProgramProgramAddress;
...
Instruction getMigrateInstruction({
  ...
  Address? registryConfig,
  Address? roleEntry,
}) {
  final resolvedProgram = programAddress ?? roleRegistryProgramProgramAddress;
  final metas = <AccountMeta>[
    ...
    AccountMeta(
      address: registryConfig ?? resolvedProgram,
      role: registryConfig == null ? AccountRole.readonly : AccountRole.writable,
    ),
    AccountMeta(
      address: roleEntry ?? resolvedProgram,
      role: roleEntry == null ? AccountRole.readonly : AccountRole.writable,
    ),
  ];
  final provided = [payer, systemProgram, registryConfig, roleEntry];
  var last = -1;
