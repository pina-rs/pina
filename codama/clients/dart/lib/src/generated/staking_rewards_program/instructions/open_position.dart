...
class OpenPositionInstructionData {
  const OpenPositionInstructionData({
    required this.bump,
  }) :
      discriminator = 1;
...
Decoder<OpenPositionInstructionData> getOpenPositionInstructionDataDecoder() {
  ...
  (OpenPositionInstructionData, int) readTopLevel(Uint8List bytes, int offset) {
    getConstantDecoder(
...
Codec<OpenPositionInstructionData, OpenPositionInstructionData> getOpenPositionInstructionDataCodec() {
...
Instruction getOpenPositionInstruction({
  ...
  final instructionData = OpenPositionInstructionData(
      bump: bump,
  );
...
OpenPositionInstructionData parseOpenPositionInstruction(Instruction instruction) {
