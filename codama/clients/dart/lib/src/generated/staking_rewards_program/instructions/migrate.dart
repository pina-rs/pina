...
import '../programs/staking_rewards_program.dart' show stakingRewardsProgramProgramAddress;
...
Instruction getMigrateInstruction({
  ...
  Address? poolState,
  Address? positionState,
}) {
  final resolvedProgram = programAddress ?? stakingRewardsProgramProgramAddress;
  final metas = <AccountMeta>[
    ...
    AccountMeta(
      address: poolState ?? resolvedProgram,
      role: poolState == null ? AccountRole.readonly : AccountRole.writable,
    ),
    AccountMeta(
      address: positionState ?? resolvedProgram,
      role: positionState == null ? AccountRole.readonly : AccountRole.writable,
    ),
  ];
  final provided = [payer, systemProgram, poolState, positionState];
  var last = -1;
