...
class EscrowState {
  ...
  @override
  int get hashCode => Object.hash(discriminator, maker, mintA, mintB, amountA, amountB, seed, bump);

  @override
  String toString() => 'EscrowState(discriminator: $discriminator, maker: $maker, mintA: $mintA, mintB: $mintB, amountA: $amountA, amountB: $amountB, seed: $seed, bump: $bump)';
}
