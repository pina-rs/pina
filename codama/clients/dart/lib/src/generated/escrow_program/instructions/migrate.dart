...
import '../programs/escrow_program.dart' show escrowProgramProgramAddress;
...
Instruction getMigrateInstruction({
  ...
  final resolvedProgram = programAddress ?? escrowProgramProgramAddress;
  final metas = <AccountMeta>[
    ...
    AccountMeta(
      address: escrowState ?? resolvedProgram,
      role: escrowState == null ? AccountRole.readonly : AccountRole.writable,
    ),
  ];
  final provided = [payer, systemProgram, escrowState];
  var last = -1;
