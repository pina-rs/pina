...
class TakeInstructionData {
  const TakeInstructionData() : discriminator = 2, migrationVersion = 0;
...
Encoder<TakeInstructionData> getTakeInstructionDataEncoder() {
  ...
  return transformEncoder(
    structEncoder,
    (TakeInstructionData value) => <String, Object?>{
      'discriminator': 2,
      'migrationVersion': 0,
    },
  );
...
Decoder<TakeInstructionData> getTakeInstructionDataDecoder() {
  ...
  (TakeInstructionData, int) readTopLevel(Uint8List bytes, int offset) {
