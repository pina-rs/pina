...
import '../programs/vesting_program.dart' show vestingProgramProgramAddress;
...
Instruction getMigrateInstruction({
  ...
  final resolvedProgram = programAddress ?? vestingProgramProgramAddress;
  final metas = <AccountMeta>[
    ...
    AccountMeta(
      address: vestingState ?? resolvedProgram,
      role: vestingState == null ? AccountRole.readonly : AccountRole.writable,
    ),
  ];
  final provided = [payer, systemProgram, vestingState];
  var last = -1;
