...
class VestingState {
  ...
  @override
  int get hashCode => Object.hash(discriminator, migrationVersion, admin, beneficiary, mint, totalAmount, claimedAmount, startTs, cliffTs, endTs, cancelled, bump);

  @override
  String toString() => 'VestingState(discriminator: $discriminator, migrationVersion: $migrationVersion, admin: $admin, beneficiary: $beneficiary, mint: $mint, totalAmount: $totalAmount, claimedAmount: $claimedAmount, startTs: $startTs, cliffTs: $cliffTs, endTs: $endTs, cancelled: $cancelled, bump: $bump)';
}
