...
import '../programs/counter_program.dart' show counterProgramProgramAddress;
...
Instruction getMigrateInstruction({
  ...
  Address? counterState,
}) {
  final resolvedProgram = programAddress ?? counterProgramProgramAddress;
  final metas = <AccountMeta>[
    ...
    AccountMeta(
      address: counterState ?? resolvedProgram,
      role: counterState == null ? AccountRole.readonly : AccountRole.writable,
    ),
  ];
  final provided = [payer, systemProgram, counterState];
  var last = -1;
