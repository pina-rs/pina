...
class TodoState {
  ...
  @override
  int get hashCode => Object.hash(discriminator, migrationVersion, owner, bump, completed, digest);

  @override
  String toString() => 'TodoState(discriminator: $discriminator, migrationVersion: $migrationVersion, owner: $owner, bump: $bump, completed: $completed, digest: $digest)';
}
