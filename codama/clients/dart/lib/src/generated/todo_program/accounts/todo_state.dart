...
class TodoState {
  ...
  @override
  int get hashCode => Object.hash(discriminator, owner, bump, completed, digest);

  @override
  String toString() => 'TodoState(discriminator: $discriminator, owner: $owner, bump: $bump, completed: $completed, digest: $digest)';
}
