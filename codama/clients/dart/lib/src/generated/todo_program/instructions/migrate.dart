...
import '../programs/todo_program.dart' show todoProgramProgramAddress;
...
Instruction getMigrateInstruction({
  ...
  final resolvedProgram = programAddress ?? todoProgramProgramAddress;
  final metas = <AccountMeta>[
    ...
    AccountMeta(
      address: todoState ?? resolvedProgram,
      role: todoState == null ? AccountRole.readonly : AccountRole.writable,
    ),
  ];
  final provided = [payer, systemProgram, todoState];
  var last = -1;
