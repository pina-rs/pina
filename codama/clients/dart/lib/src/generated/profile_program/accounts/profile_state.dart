...
class ProfileState {
  ...
  @override
  int get hashCode => Object.hash(discriminator, migrationVersion, bump, name, bio, tags, favoriteTag, active);

  @override
  String toString() => 'ProfileState(discriminator: $discriminator, migrationVersion: $migrationVersion, bump: $bump, name: $name, bio: $bio, tags: $tags, favoriteTag: $favoriteTag, active: $active)';
}
