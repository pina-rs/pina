...
import '../programs/profile_program.dart' show profileProgramProgramAddress;
...
Instruction getMigrateInstruction({
  ...
  Address? profileState,
}) {
  final resolvedProgram = programAddress ?? profileProgramProgramAddress;
  ...
  final provided = [payer, systemProgram, profileState];
  var last = -1;
