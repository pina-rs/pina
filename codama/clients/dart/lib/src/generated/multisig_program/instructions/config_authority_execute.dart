...
getConfigAuthorityExecuteInstructionDataDecoder() {
  ...
  return switch (structDecoder) {
    FixedSizeDecoder<Map<String, Object?>>() =>
      FixedSizeDecoder<ConfigAuthorityExecuteInstructionData>(
    ...
    VariableSizeDecoder<Map<String, Object?>>() =>
      VariableSizeDecoder<ConfigAuthorityExecuteInstructionData>(
        read: readTopLevel,
...
Instruction getConfigAuthorityExecuteInstruction({
