...
Encoder<ProposalActivateInstructionData> getProposalActivateInstructionDataEncoder() {
...
Decoder<ProposalActivateInstructionData> getProposalActivateInstructionDataDecoder() {
  ...
  (ProposalActivateInstructionData, int) readTopLevel(Uint8List bytes, int offset) {
    getConstantDecoder(
...
Codec<ProposalActivateInstructionData, ProposalActivateInstructionData> getProposalActivateInstructionDataCodec() {
  return combineCodec(getProposalActivateInstructionDataEncoder(), getProposalActivateInstructionDataDecoder());
}
...
ProposalActivateInstructionData parseProposalActivateInstruction(Instruction instruction) {
