...
class ProgramConfig {
  ...
  @override
  int get hashCode => Object.hash(discriminator, migrationVersion, bump, authority, treasury, creationFee);

  @override
  String toString() => 'ProgramConfig(discriminator: $discriminator, migrationVersion: $migrationVersion, bump: $bump, authority: $authority, treasury: $treasury, creationFee: $creationFee)';
}
...
Decoder<ProgramConfig> getProgramConfigDecoder() {
  ...
  return switch (structDecoder) {
    FixedSizeDecoder<Map<String, Object?>>() =>
      FixedSizeDecoder<ProgramConfig>(
