...
import '../programs/validation_program.dart' show validationProgramProgramAddress;
...
Instruction getMigrateInstruction({
  ...
  final resolvedProgram = programAddress ?? validationProgramProgramAddress;
  final metas = <AccountMeta>[
    ...
    AccountMeta(
      address: policyState ?? resolvedProgram,
      role: policyState == null ? AccountRole.readonly : AccountRole.writable,
    ),
  ];
  final provided = [payer, systemProgram, policyState];
  var last = -1;
