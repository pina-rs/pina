...
Instruction getUpdateInstruction({
  ...
  return Instruction(
    ...
    if (referrer != null) AccountMeta(address: referrer, role: AccountRole.readonly) else AccountMeta(address: programAddress, role: AccountRole.readonly),
    if (state != null) AccountMeta(address: state, role: AccountRole.writable) else AccountMeta(address: programAddress, role: AccountRole.readonly),
    if (migrationPayer != null) AccountMeta(address: migrationPayer, role: AccountRole.writableSigner) else AccountMeta(address: programAddress, role: AccountRole.readonly),
    ...
    if (manualState != null) AccountMeta(address: manualState, role: AccountRole.writable) else AccountMeta(address: programAddress, role: AccountRole.readonly),
    if (compactState != null) AccountMeta(address: compactState, role: AccountRole.writable) else AccountMeta(address: programAddress, role: AccountRole.readonly),
    ],
