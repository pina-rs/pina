...
class State {
  ...
  @override
  int get hashCode => Object.hash(discriminator, migrationVersion, authority, value, enabled, revision);

  @override
  String toString() => 'State(discriminator: $discriminator, migrationVersion: $migrationVersion, authority: $authority, value: $value, enabled: $enabled, revision: $revision)';
}
