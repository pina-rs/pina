...
class ManualState {
  ...
  @override
  String toString() => 'ManualState(discriminator: $discriminator, migrationVersion: $migrationVersion, code: $code)';
}
...
Encoder<ManualState> getManualStateEncoder() {
  final structEncoder = getStructEncoder(<(String, Encoder<Object?>)>[
    ...
    ('code', getPinaPodBoundedStringEncoder(addEncoderSizePrefix(getUtf8Encoder(), getU8Encoder()), 5)),
  ]);
...
Decoder<ManualState> getManualStateDecoder() {
  final structDecoder = getStructDecoder(<(String, Decoder<Object?>)>[
    ...
    ('code', getPinaPodBoundedStringDecoder(addDecoderSizePrefix(getUtf8Decoder(), getPinaPodBoundedCountDecoder(getU8Decoder(), 5)), 5)),
  ]);
