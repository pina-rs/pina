...
import '../programs/pina_bpf_program.dart' show pinaBpfProgramProgramAddress;
...
Instruction getMigrateInstruction({
  ...
  final resolvedProgram = programAddress ?? pinaBpfProgramProgramAddress;
  ...
  final provided = [payer, systemProgram, state];
  var last = -1;
