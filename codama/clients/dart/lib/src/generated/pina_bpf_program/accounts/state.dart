...
@immutable
class State {
  const State({required this.bump}) : discriminator = 1, migrationVersion = 0;
  ...
  @override
  String toString() =>
      'State(discriminator: $discriminator, migrationVersion: $migrationVersion, bump: $bump)';
}
...
const int stateMigrationVersion = 0;
