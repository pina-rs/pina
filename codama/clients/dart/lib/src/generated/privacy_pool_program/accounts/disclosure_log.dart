...
class DisclosureLog {
  ...
  @override
  int get hashCode => Object.hash(discriminator, migrationVersion, bump, count, entries);

  @override
  String toString() => 'DisclosureLog(discriminator: $discriminator, migrationVersion: $migrationVersion, bump: $bump, count: $count, entries: $entries)';
}
...
Encoder<DisclosureLog> getDisclosureLogEncoder() {
  final structEncoder = getStructEncoder(<(String, Encoder<Object?>)>[
    ...
    ('bump', getU8Encoder()),
    ('count', getU64Encoder()),
    ('entries', fixEncoderSize(getBytesEncoder(), 3072, allowTruncation: false)),
  ]);
...
Decoder<DisclosureLog> getDisclosureLogDecoder() {
  ...
  return switch (structDecoder) {
    FixedSizeDecoder<Map<String, Object?>>() =>
      FixedSizeDecoder<DisclosureLog>(
