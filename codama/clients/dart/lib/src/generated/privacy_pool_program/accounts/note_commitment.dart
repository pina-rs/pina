...
class NoteCommitment {
  ...
  @override
  String toString() =>
      'NoteCommitment(discriminator: $discriminator, migrationVersion: $migrationVersion, bump: $bump, commitment: $commitment, viewPubkey: $viewPubkey, envelopeLen: $envelopeLen, envelope: $envelope, shares: $shares)';
}
