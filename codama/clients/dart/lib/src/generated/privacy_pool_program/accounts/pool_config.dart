...
class PoolConfig {
  ...
  @override
  int get hashCode => Object.hash(discriminator, migrationVersion, bump, authority, custodianThreshold, challengeWindowSecs, depositLamports, totalDeposits);

  @override
  String toString() => 'PoolConfig(discriminator: $discriminator, migrationVersion: $migrationVersion, bump: $bump, authority: $authority, custodianThreshold: $custodianThreshold, challengeWindowSecs: $challengeWindowSecs, depositLamports: $depositLamports, totalDeposits: $totalDeposits)';
}
