...
Instruction getMigrateInstruction({
  ...
  Address? requesterRegistry,
  Address? noteCommitment,
  Address? disclosureRequest,
  Address? disclosureLog,
  Address? verifyingKeyAccount,
}) {
  final resolvedProgram = programAddress ?? privacyPoolProgramProgramAddress;
  final metas = <AccountMeta>[
    ...
    AccountMeta(
      address: poolVault ?? resolvedProgram,
      role: poolVault == null ? AccountRole.readonly : AccountRole.writable,
    ),
    AccountMeta(
      address: merkleTree ?? resolvedProgram,
      role: merkleTree == null ? AccountRole.readonly : AccountRole.writable,
    ),
    AccountMeta(
      address: nullifierSet ?? resolvedProgram,
      role: nullifierSet == null ? AccountRole.readonly : AccountRole.writable,
    ),
    AccountMeta(
    ...
    AccountMeta(
      ...
      role: disclosureLog == null ? AccountRole.readonly : AccountRole.writable,
    ),
    AccountMeta(
