...
Codec<ReallocInstructionData, ReallocInstructionData> getReallocInstructionDataCodec() {
...
Instruction getReallocInstruction({
  ...
  final instructionData = ReallocInstructionData(
      len: len,
  );
