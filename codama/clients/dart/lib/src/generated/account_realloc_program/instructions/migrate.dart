...
import '../programs/account_realloc_program.dart' show accountReallocProgramProgramAddress;
...
Instruction getMigrateInstruction({
  ...
  final resolvedProgram = programAddress ?? accountReallocProgramProgramAddress;
  final metas = <AccountMeta>[
    ...
    AccountMeta(
      address: sample ?? resolvedProgram,
      role: sample == null ? AccountRole.readonly : AccountRole.writable,
    ),
  ];
  final provided = [payer, systemProgram, sample];
  var last = -1;
