...
class HelloNoMsgInstructionData {
  const HelloNoMsgInstructionData() :
      discriminator = 1;
...
Encoder<HelloNoMsgInstructionData> getHelloNoMsgInstructionDataEncoder() {
  ...
  return transformEncoder(
    structEncoder,
    (HelloNoMsgInstructionData value) => <String, Object?>{
      'discriminator': 1,
    },
  );
}
...
Decoder<HelloNoMsgInstructionData> getHelloNoMsgInstructionDataDecoder() {
  ...
  (HelloNoMsgInstructionData, int) readTopLevel(Uint8List bytes, int offset) {
    getConstantDecoder(
...
Codec<HelloNoMsgInstructionData, HelloNoMsgInstructionData> getHelloNoMsgInstructionDataCodec() {
...
Instruction getHelloNoMsgInstruction({
