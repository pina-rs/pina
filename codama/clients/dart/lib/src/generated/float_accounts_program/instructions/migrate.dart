...
import '../programs/float_accounts_program.dart' show floatAccountsProgramProgramAddress;
...
Instruction getMigrateInstruction({
  ...
  Address? floatDataAccount,
}) {
  final resolvedProgram = programAddress ?? floatAccountsProgramProgramAddress;
  final metas = <AccountMeta>[
    ...
    AccountMeta(
      address: floatDataAccount ?? resolvedProgram,
      role: floatDataAccount == null ? AccountRole.readonly : AccountRole.writable,
    ),
  ];
  final provided = [payer, systemProgram, floatDataAccount];
  var last = -1;
