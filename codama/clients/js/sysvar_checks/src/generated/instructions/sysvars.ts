...
import { SYSVAR_CHECKS_PROGRAM_ADDRESS } from "../programs";
...
export type SysvarsInstruction<
	TProgram extends string = typeof SYSVAR_CHECKS_PROGRAM_ADDRESS,
...
export function getSysvarsInstruction<
	...
	TAccountStakeHistory extends string,
	TProgramAddress extends Address = typeof SYSVAR_CHECKS_PROGRAM_ADDRESS,
>(
