...
export type MigrateInstruction<
	...
	TAccountCounterState extends string | AccountMeta<string> = string,
...
> =
	...
	& InstructionWithAccounts<
		[
			...
			TAccountCounterState extends string
				? WritableAccount<TAccountCounterState>
				: TAccountCounterState,
			...TRemainingAccounts,
		]
	>;
...
export type MigrateInput<
	...
	TAccountCounterState extends string = string,
> = {
	payer?: TransactionSigner<TAccountPayer>;
	systemProgram?: Address<TAccountSystemProgram>;
	counterState?: Address<TAccountCounterState>;
};
...
> {
	...
	const originalAccounts = {
		...
		counterState: { value: input.counterState ?? null, isWritable: true },
	};
	...
	// placeholder.
	const provided = [input.payer, input.systemProgram, input.counterState];
	let lastProvided = -1;
	...
	return Object.freeze({
		accounts: [
			...
			getAccountMeta("counterState", accounts.counterState),
