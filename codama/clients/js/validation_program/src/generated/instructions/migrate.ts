...
export type MigrateInstruction<
	...
	TAccountPolicyState extends string | AccountMeta<string> = string,
...
> =
	...
	& InstructionWithAccounts<
		[
			...
			TAccountPolicyState extends string ? WritableAccount<TAccountPolicyState>
				: TAccountPolicyState,
			...TRemainingAccounts,
		]
	>;
...
export type MigrateInput<
	...
	TAccountPolicyState extends string = string,
> = {
	payer?: TransactionSigner<TAccountPayer>;
	systemProgram?: Address<TAccountSystemProgram>;
	policyState?: Address<TAccountPolicyState>;
};
...
> {
	...
	const originalAccounts = {
		...
		policyState: { value: input.policyState ?? null, isWritable: true },
	};
	...
	// placeholder.
	const provided = [input.payer, input.systemProgram, input.policyState];
	let lastProvided = -1;
	...
	return Object.freeze({
		accounts: [
			...
			getAccountMeta("policyState", accounts.policyState),
