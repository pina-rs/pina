...
export type FailsDuplicateMutableInstruction<
	TProgram extends string = typeof DUPLICATE_MUTABLE_ACCOUNTS_PROGRAM_ADDRESS,
	...
	& InstructionWithAccounts<
		[
			TAccountAccount1 extends string ? WritableAccount<TAccountAccount1>
				: TAccountAccount1,
			TAccountAccount2 extends string ? WritableAccount<TAccountAccount2>
				: TAccountAccount2,
			...TRemainingAccounts,
		]
	>;
...
export function getFailsDuplicateMutableInstruction<
	TAccountAccount1 extends string,
	TAccountAccount2 extends string,
	TProgramAddress extends Address =
		typeof DUPLICATE_MUTABLE_ACCOUNTS_PROGRAM_ADDRESS,
>(
	input: FailsDuplicateMutableInput<TAccountAccount1, TAccountAccount2>,
	config?: { programAddress?: TProgramAddress },
): FailsDuplicateMutableInstruction<
	TProgramAddress,
	TAccountAccount1,
	TAccountAccount2
> {
	...
	const originalAccounts = {
		account1: { value: input.account1 ?? null, isWritable: true },
		account2: { value: input.account2 ?? null, isWritable: true },
	};
