...
import { EVENTS_PROGRAM_ADDRESS } from "../programs";
...
export type TestEventCpiInstruction<
	TProgram extends string = typeof EVENTS_PROGRAM_ADDRESS,
...
export function getTestEventCpiInstruction<
	TProgramAddress extends Address = typeof EVENTS_PROGRAM_ADDRESS,
>(
	config?: { programAddress?: TProgramAddress },
): TestEventCpiInstruction<TProgramAddress> {
	// Program address.
	const programAddress = config?.programAddress ?? EVENTS_PROGRAM_ADDRESS;
