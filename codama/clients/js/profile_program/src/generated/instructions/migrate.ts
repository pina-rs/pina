...
export type MigrateInstruction<
	...
	TAccountProfileState extends string | AccountMeta<string> = string,
...
> =
	...
	& InstructionWithAccounts<
		[
			...
			TAccountProfileState extends string
				? WritableAccount<TAccountProfileState>
...
export type MigrateInput<
	...
	TAccountProfileState extends string = string,
> = {
	payer?: TransactionSigner<TAccountPayer>;
	systemProgram?: Address<TAccountSystemProgram>;
	profileState?: Address<TAccountProfileState>;
};
...
> {
	...
	const originalAccounts = {
		...
		profileState: { value: input.profileState ?? null, isWritable: true },
	};
	...
	// placeholder.
	const provided = [input.payer, input.systemProgram, input.profileState];
	let lastProvided = -1;
	...
	return Object.freeze({
		accounts: [
			...
			getAccountMeta("profileState", accounts.profileState),
