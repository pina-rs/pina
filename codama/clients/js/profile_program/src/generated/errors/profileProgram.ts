...
export type ProfileProgramError = typeof PROFILE_PROGRAM_ERROR__TAG_NOT_FOUND | typeof PROFILE_PROGRAM_ERROR__TAG_OVERFLOW;

let profileProgramErrorMessages: Record<ProfileProgramError, string> | undefined;
if (process.env['NODE_ENV'] !== 'production') {
  profileProgramErrorMessages = { [PROFILE_PROGRAM_ERROR__TAG_NOT_FOUND]: `The tag index is out of range.`, [PROFILE_PROGRAM_ERROR__TAG_OVERFLOW]: `The tag list is full (capacity 8).` };
}
