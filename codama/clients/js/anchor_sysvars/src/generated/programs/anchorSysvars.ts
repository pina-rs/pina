...
export const ANCHOR_SYSVARS_PROGRAM_ADDRESS =
	"Fg6PaFpoGXkYsidMpWTK6W2BeZ7FEfcYkg476zPFsLnS" as Address<
		"Fg6PaFpoGXkYsidMpWTK6W2BeZ7FEfcYkg476zPFsLnS"
	>;

export enum AnchorSysvarsInstruction {
	Sysvars,
}

export function identifyAnchorSysvarsInstruction(
	instruction: { data: ReadonlyUint8Array } | ReadonlyUint8Array,
): AnchorSysvarsInstruction {
	...
	throw new SolanaError(
		SOLANA_ERROR__PROGRAM_CLIENTS__FAILED_TO_IDENTIFY_INSTRUCTION,
		{ instructionData: data, programName: "anchorSysvars" },
	);
}

export type ParsedAnchorSysvarsInstruction<
	TProgram extends string = "Fg6PaFpoGXkYsidMpWTK6W2BeZ7FEfcYkg476zPFsLnS",
> =
	& { instructionType: AnchorSysvarsInstruction.Sysvars }
...
export function parseAnchorSysvarsInstruction<TProgram extends string>(
	...
	switch (instructionType) {
		case AnchorSysvarsInstruction.Sysvars: {
...
export type AnchorSysvarsPluginRequirements =
