...
export const HELLO_NEXT_DISCRIMINATOR2 = 0;

export function getHelloNextDiscriminator2Bytes(): ReadonlyUint8Array {
	return getU8Encoder().encode(HELLO_NEXT_DISCRIMINATOR2);
}
...
export type HelloNextInstructionData = {
