...
export type MigrateInstruction<
	...
	TAccountStoreState extends string | AccountMeta<string> = string,
...
> =
	...
	& InstructionWithAccounts<
		[
			...
			TAccountStoreState extends string ? WritableAccount<TAccountStoreState>
				: TAccountStoreState,
			...TRemainingAccounts,
		]
	>;
...
export type MigrateInput<
	...
	TAccountStoreState extends string = string,
> = {
	payer?: TransactionSigner<TAccountPayer>;
	systemProgram?: Address<TAccountSystemProgram>;
	storeState?: Address<TAccountStoreState>;
};
...
> {
	...
	const originalAccounts = {
		...
		storeState: { value: input.storeState ?? null, isWritable: true },
	};
	...
	// placeholder.
	const provided = [input.payer, input.systemProgram, input.storeState];
	let lastProvided = -1;
	...
	return Object.freeze({
		accounts: [
			...
			getAccountMeta("storeState", accounts.storeState),
