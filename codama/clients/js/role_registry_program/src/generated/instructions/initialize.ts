...
const programAddress = config?.programAddress ?? ROLE_REGISTRY_PROGRAM_PROGRAM_ADDRESS;
 ...
 // Original accounts.
const originalAccounts = { admin: { value: input.admin ?? null, isWritable: false }, registryConfig: { value: input.registryConfig ?? null, isWritable: true }, systemProgram: { value: input.systemProgram ?? null, isWritable: false } }
