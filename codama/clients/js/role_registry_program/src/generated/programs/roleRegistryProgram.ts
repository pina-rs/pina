...
import { getAddRoleInstruction, getDeactivateRoleInstruction, getInitializeInstructionAsync, getRotateAdminInstruction, getUpdateRoleInstruction, parseAddRoleInstruction, parseDeactivateRoleInstruction, parseInitializeInstruction, parseRotateAdminInstruction, parseUpdateRoleInstruction, type AddRoleInput, type DeactivateRoleInput, type InitializeAsyncInput, type ParsedAddRoleInstruction, type ParsedDeactivateRoleInstruction, type ParsedInitializeInstruction, type ParsedRotateAdminInstruction, type ParsedUpdateRoleInstruction, type RotateAdminInput, type UpdateRoleInput } from '../instructions';
...
export type RoleRegistryProgramPlugin = { accounts: RoleRegistryProgramPluginAccounts; instructions: RoleRegistryProgramPluginInstructions; pdas: RoleRegistryProgramPluginPdas; identifyAccount: typeof identifyRoleRegistryProgramAccount; identifyInstruction: typeof identifyRoleRegistryProgramInstruction; parseInstruction: typeof parseRoleRegistryProgramInstruction; }
...
export function roleRegistryProgramProgram() {
    return <T extends RoleRegistryProgramPluginRequirements>(client: T): ExtendedClient<T, { roleRegistryProgram: RoleRegistryProgramPlugin }> => {
        return extendClient(client, { roleRegistryProgram: <RoleRegistryProgramPlugin>{ accounts: { registryConfig: addSelfFetchFunctions(client, getRegistryConfigCodec()), roleEntry: addSelfFetchFunctions(client, getRoleEntryCodec()) }, instructions: { initialize: input => addSelfPlanAndSendFunctions(client, getInitializeInstructionAsync(input)), addRole: input => addSelfPlanAndSendFunctions(client, getAddRoleInstruction(input)), updateRole: input => addSelfPlanAndSendFunctions(client, getUpdateRoleInstruction(input)), deactivateRole: input => addSelfPlanAndSendFunctions(client, getDeactivateRoleInstruction(input)), rotateAdmin: input => addSelfPlanAndSendFunctions(client, getRotateAdminInstruction(input)) }, pdas: { registryConfig: findRegistryConfigPda, roleEntry: findRoleEntryPda }, identifyAccount: identifyRoleRegistryProgramAccount, identifyInstruction: identifyRoleRegistryProgramInstruction, parseInstruction: parseRoleRegistryProgramInstruction } });
    };
}