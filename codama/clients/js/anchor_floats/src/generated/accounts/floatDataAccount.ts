...
export type FloatDataAccountArgs = {
...
export function getFloatDataAccountCodec(): FixedSizeCodec<
	FloatDataAccountArgs,
	FloatDataAccount
> {
	return combineCodec(
...
export function decodeFloatDataAccount<TAddress extends string = string>(
	encodedAccount: EncodedAccount<TAddress>,
): Account<FloatDataAccount, TAddress>;
export function decodeFloatDataAccount<TAddress extends string = string>(
	encodedAccount: MaybeEncodedAccount<TAddress>,
): MaybeAccount<FloatDataAccount, TAddress>;
export function decodeFloatDataAccount<TAddress extends string = string>(
...
export async function fetchMaybeFloatDataAccount<
...
export async function fetchAllFloatDataAccount(
	...
	const maybeAccounts = await fetchAllMaybeFloatDataAccount(
		rpc,
		addresses,
		config,
	);
