...
export function getUpdateInstructionDataEncoder(): FixedSizeEncoder<UpdateInstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', getU8Encoder()], ['newPrice', getU64Encoder()]]), (value) => ({ ...value, discriminator: 1 }));
}

export function getUpdateInstructionDataDecoder(): FixedSizeDecoder<UpdateInstructionData> {
    return getStructDecoder([['discriminator', getPinaPodDiscriminatorDecoder(UPDATE_DISCRIMINATOR, getU8Decoder())], ['newPrice', getU64Decoder()]]);
}
