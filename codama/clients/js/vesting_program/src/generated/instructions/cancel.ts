...
return Object.freeze({ accounts: [getAccountMeta("admin", accounts.admin), getAccountMeta("mint", accounts.mint), getAccountMeta("vestingState", accounts.vestingState), getAccountMeta("vault", accounts.vault), getAccountMeta("tokenProgram", accounts.tokenProgram)], programAddress } as CancelInstruction<TProgramAddress, TAccountAdmin, TAccountMint, TAccountVestingState, TAccountVault, TAccountTokenProgram>);
}
...
export function parseCancelInstruction<TProgram extends string, TAccountMetas extends readonly AccountMeta[]>(instruction: Instruction<TProgram> & InstructionWithAccounts<TAccountMetas>): ParsedCancelInstruction<TProgram, TAccountMetas> {
...
const getNextAccount = () => {
  ...
  return { programAddress: instruction.programAddress, accounts: { admin: getNextAccount(), mint: getNextAccount(), vestingState: getNextAccount(), vault: getNextAccount(), tokenProgram: getNextAccount() } };
}