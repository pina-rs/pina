...
export type StakingRewardsProgramPlugin = { accounts: StakingRewardsProgramPluginAccounts; instructions: StakingRewardsProgramPluginInstructions; pdas: StakingRewardsProgramPluginPdas; identifyAccount: typeof identifyStakingRewardsProgramAccount; identifyInstruction: typeof identifyStakingRewardsProgramInstruction; parseInstruction: typeof parseStakingRewardsProgramInstruction; }
...
export function stakingRewardsProgramProgram() {
    return <T extends StakingRewardsProgramPluginRequirements>(client: T): ExtendedClient<T, { stakingRewardsProgram: StakingRewardsProgramPlugin }> => {
        return extendClient(client, { stakingRewardsProgram: <StakingRewardsProgramPlugin>{ accounts: { poolState: addSelfFetchFunctions(client, getPoolStateCodec()), positionState: addSelfFetchFunctions(client, getPositionStateCodec()) }, instructions: { initializePool: input => addSelfPlanAndSendFunctions(client, getInitializePoolInstructionAsync(input)), openPosition: input => addSelfPlanAndSendFunctions(client, getOpenPositionInstruction(input)), deposit: input => addSelfPlanAndSendFunctions(client, getDepositInstruction(input)), withdraw: input => addSelfPlanAndSendFunctions(client, getWithdrawInstruction(input)), claim: input => addSelfPlanAndSendFunctions(client, getClaimInstruction(input)) }, pdas: { pool: findPoolPda, position: findPositionPda }, identifyAccount: identifyStakingRewardsProgramAccount, identifyInstruction: identifyStakingRewardsProgramInstruction, parseInstruction: parseStakingRewardsProgramInstruction } });
    };
}