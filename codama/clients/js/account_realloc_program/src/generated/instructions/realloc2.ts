...
export function getRealloc2DiscriminatorBytes(): ReadonlyUint8Array { return getU8Encoder().encode(REALLOC2_DISCRIMINATOR); }
...
export function getRealloc2InstructionDataEncoder(): FixedSizeEncoder<Realloc2InstructionDataArgs> {
    return transformEncoder(getStructEncoder([['discriminator', getU8Encoder()], ['len', getU16Encoder()]]), (value) => ({ ...value, discriminator: 1 }));
}

export function getRealloc2InstructionDataDecoder(): FixedSizeDecoder<Realloc2InstructionData> {
    return getStructDecoder([['discriminator', getPinaPodDiscriminatorDecoder(REALLOC2_DISCRIMINATOR, getU8Decoder())], ['len', getU16Decoder()]]);
}
...
export type ParsedRealloc2Instruction<TProgram extends string = typeof ACCOUNT_REALLOC_PROGRAM_PROGRAM_ADDRESS, TAccountMetas extends readonly AccountMeta[] = readonly AccountMeta[]> = { programAddress: Address<TProgram>;
accounts: {
