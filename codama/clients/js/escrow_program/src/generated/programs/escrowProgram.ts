...
export type EscrowProgramPlugin = { accounts: EscrowProgramPluginAccounts; instructions: EscrowProgramPluginInstructions; pdas: EscrowProgramPluginPdas; identifyAccount: typeof identifyEscrowProgramAccount; identifyInstruction: typeof identifyEscrowProgramInstruction; parseInstruction: typeof parseEscrowProgramInstruction; }
...
export function escrowProgramProgram() {
    return <T extends EscrowProgramPluginRequirements>(client: T): ExtendedClient<T, { escrowProgram: EscrowProgramPlugin }> => {
        return extendClient(client, { escrowProgram: <EscrowProgramPlugin>{ accounts: { escrowState: addSelfFetchFunctions(client, getEscrowStateCodec()) }, instructions: { make: input => addSelfPlanAndSendFunctions(client, getMakeInstruction(input)), take: input => addSelfPlanAndSendFunctions(client, getTakeInstruction(input)) }, pdas: { escrow: findEscrowPda }, identifyAccount: identifyEscrowProgramAccount, identifyInstruction: identifyEscrowProgramInstruction, parseInstruction: parseEscrowProgramInstruction } });
    };
}