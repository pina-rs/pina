...
const programAddress = config?.programAddress ?? ESCROW_PROGRAM_PROGRAM_ADDRESS;
 ...
 // Original accounts.
const originalAccounts = { taker: { value: input.taker ?? null, isWritable: true }, mintA: { value: input.mintA ?? null, isWritable: false }, mintB: { value: input.mintB ?? null, isWritable: false }, takerAtaA: { value: input.takerAtaA ?? null, isWritable: false }, takerAtaB: { value: input.takerAtaB ?? null, isWritable: true }, maker: { value: input.maker ?? null, isWritable: false }, makerAtaB: { value: input.makerAtaB ?? null, isWritable: true }, escrow: { value: input.escrow ?? null, isWritable: true }, vault: { value: input.vault ?? null, isWritable: true }, tokenProgram: { value: input.tokenProgram ?? null, isWritable: false }, systemProgram: { value: input.systemProgram ?? null, isWritable: false } }
