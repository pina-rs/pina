...
> =
	...
	& InstructionWithAccounts<
		[
			...
			TAccountEscrowState extends string ? WritableAccount<TAccountEscrowState>
				: TAccountEscrowState,
			...TRemainingAccounts,
		]
	>;
...
> {
	...
	// placeholder.
	const provided = [input.payer, input.systemProgram, input.escrowState];
	let lastProvided = -1;
	...
	return Object.freeze({
		accounts: [
			...
			getAccountMeta("escrowState", accounts.escrowState),
