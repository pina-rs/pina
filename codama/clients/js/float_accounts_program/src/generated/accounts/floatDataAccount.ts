...
export function getFloatDataAccountDiscriminatorBytes(): ReadonlyUint8Array { return getU8Encoder().encode(FLOAT_DATA_ACCOUNT_DISCRIMINATOR); }

export type FloatDataAccount = { discriminator: number; dataF64: bigint; dataF32: number; authority: Address;  };
...
export function getFloatDataAccountEncoder(): FixedSizeEncoder<FloatDataAccountArgs> {
    return transformEncoder(getStructEncoder([['discriminator', getU8Encoder()], ['dataF64', getU64Encoder()], ['dataF32', getU32Encoder()], ['authority', getAddressEncoder()]]), (value) => ({ ...value, discriminator: 1 }));
}
...
export function getFloatDataAccountDecoder(): FixedSizeDecoder<FloatDataAccount> {
    return getStructDecoder([['discriminator', getPinaPodDiscriminatorDecoder(FLOAT_DATA_ACCOUNT_DISCRIMINATOR, getU8Decoder())], ['dataF64', getU64Decoder()], ['dataF32', getU32Decoder()], ['authority', getAddressDecoder()]]);
}
