...
export type MigrateInstruction<
	...
	TAccountFloatDataAccount extends string | AccountMeta<string> = string,
...
> =
	...
	& InstructionWithAccounts<
		[
			...
			TAccountFloatDataAccount extends string
				? WritableAccount<TAccountFloatDataAccount>
				: TAccountFloatDataAccount,
			...TRemainingAccounts,
		]
	>;
...
export type MigrateInput<
	...
	TAccountFloatDataAccount extends string = string,
> = {
	payer?: TransactionSigner<TAccountPayer>;
	systemProgram?: Address<TAccountSystemProgram>;
	floatDataAccount?: Address<TAccountFloatDataAccount>;
};
