...
export type MigrateInstruction<
	...
	TAccountTodoState extends string | AccountMeta<string> = string,
...
> =
	...
	& InstructionWithAccounts<
		[
			...
			TAccountTodoState extends string ? WritableAccount<TAccountTodoState>
				: TAccountTodoState,
			...TRemainingAccounts,
		]
	>;
...
export type MigrateInput<
	...
	TAccountTodoState extends string = string,
> = {
	payer?: TransactionSigner<TAccountPayer>;
	systemProgram?: Address<TAccountSystemProgram>;
	todoState?: Address<TAccountTodoState>;
};
...
> {
	...
	const programAddress = config?.programAddress ??
		TODO_PROGRAM_PROGRAM_ADDRESS;

	// Original accounts.
	const originalAccounts = {
		payer: { value: input.payer ?? null, isWritable: true },
		systemProgram: { value: input.systemProgram ?? null, isWritable: false },
		todoState: { value: input.todoState ?? null, isWritable: true },
	};
	...
	// placeholder.
	const provided = [input.payer, input.systemProgram, input.todoState];
	let lastProvided = -1;
	...
	return Object.freeze({
		accounts: [
			...
			getAccountMeta("todoState", accounts.todoState),
