...
export enum CompactAccountsProgramAccount {
	Journal,
}

export function identifyCompactAccountsProgramAccount(
...
export enum CompactAccountsProgramInstruction {
	Initialize,
	Resize,
	Write,
	Rename,
...
export function identifyCompactAccountsProgramInstruction(
...
export type ParsedCompactAccountsProgramInstruction<
	TProgram extends string = "85qGHkkBAdE61PZSNF9R6UYakqw8d5eonqi4jbFLaSTn",
> =
	| { instructionType: CompactAccountsProgramInstruction.Initialize }
		& ParsedInitializeInstruction<TProgram>
	| { instructionType: CompactAccountsProgramInstruction.Resize }
		& ParsedResizeInstruction<TProgram>
	| { instructionType: CompactAccountsProgramInstruction.Write }
		& ParsedWriteInstruction<TProgram>
	| { instructionType: CompactAccountsProgramInstruction.Rename }
...
export function parseCompactAccountsProgramInstruction<TProgram extends string>(
	...
	const instructionType = identifyCompactAccountsProgramInstruction(
		instruction,
	);
	switch (instructionType) {
		case CompactAccountsProgramInstruction.Initialize: {
		...
		case CompactAccountsProgramInstruction.Resize: {
			assertIsInstructionWithAccounts(instruction);
			return {
				instructionType: CompactAccountsProgramInstruction.Resize,
		...
		case CompactAccountsProgramInstruction.Write: {
			assertIsInstructionWithAccounts(instruction);
			return {
				instructionType: CompactAccountsProgramInstruction.Write,
		...
		case CompactAccountsProgramInstruction.Rename: {
			assertIsInstructionWithAccounts(instruction);
			return {
				instructionType: CompactAccountsProgramInstruction.Rename,
...
export type CompactAccountsProgramPlugin = {
	accounts: CompactAccountsProgramPluginAccounts;
	instructions: CompactAccountsProgramPluginInstructions;
	pdas: CompactAccountsProgramPluginPdas;
	identifyAccount: typeof identifyCompactAccountsProgramAccount;
	identifyInstruction: typeof identifyCompactAccountsProgramInstruction;
	parseInstruction: typeof parseCompactAccountsProgramInstruction;
};

export type CompactAccountsProgramPluginAccounts = {
	journal:
...
export type CompactAccountsProgramPluginPdas = {
	journal: typeof findJournalPda;
};

export type CompactAccountsProgramPluginRequirements =
	& ClientWithRpc<GetAccountInfoApi & GetMultipleAccountsApi>
	& ClientWithTransactionPlanning
	& ClientWithTransactionSending;

export function compactAccountsProgramProgram() {
	return <T extends CompactAccountsProgramPluginRequirements>(
		client: T,
	): ExtendedClient<
		T,
	...
	> => {
		return extendClient(client, {
			compactAccountsProgram: <CompactAccountsProgramPlugin> {
				...
				identifyInstruction: identifyCompactAccountsProgramInstruction,
				parseInstruction: parseCompactAccountsProgramInstruction,
			},
		});
	};
}
