...
import { getProposalRejectInstruction } from "../client";
import {
	base58,
	base58Vec,
	bigInteger,
...
export const proposalRejectCommand = registerGlobals(
	new Command("proposal_reject"),
)
	.description("proposalReject")
