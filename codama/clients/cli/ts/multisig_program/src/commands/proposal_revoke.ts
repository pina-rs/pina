...
import { getProposalRevokeInstruction } from "../client";
import {
	base58,
	base58Vec,
	bigInteger,
...
export const proposalRevokeCommand = registerGlobals(
	new Command("proposal_revoke"),
)
	...
	.action(async (options) => {
		...
		const instruction = getProposalRevokeInstruction(
			...[input],
