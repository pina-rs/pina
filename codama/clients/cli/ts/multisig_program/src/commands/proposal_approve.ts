...
import { getProposalApproveInstruction } from "../client";
import {
	base58,
	base58Vec,
	bigInteger,
...
export const proposalApproveCommand = registerGlobals(
	new Command("proposal_approve"),
)
	.description("proposalApprove")
