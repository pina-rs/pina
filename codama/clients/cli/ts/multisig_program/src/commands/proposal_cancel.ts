...
import { getProposalCancelInstruction } from "../client";
import {
	base58,
	base58Vec,
	bigInteger,
...
export const proposalCancelCommand = registerGlobals(
	new Command("proposal_cancel"),
)
	.description("proposalCancel")
	...
	.action(async (options) => {
		...
		const instruction = getProposalCancelInstruction(
			...[input],
