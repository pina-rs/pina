...
import { fetchFloatDataAccount } from "./client";
import {
	bigInteger,
	CliContext,
	CliError,
...
export const fetchCommand = registerGlobals(new Command("fetch"))
	...
	.addCommand(
		registerGlobals(new Command("float-data-account"))
			.description("float_data_account")
			.option(
				"--address <address>",
			...
			.action(async (options) => {
				...
				printAccount(context.json, "float-data-account", address, account.data);
			}),
	);
