...
pub fn program_error_name(code: u32) -> Option<&'static str> {
	match code {
		0 => Some("NotAmember"),
		1 => Some("Unauthorized"),
		2 => Some("InvalidThreshold"),
		3 => Some("TooManyMembers"),
		4 => Some("DuplicateMember"),
		5 => Some("UnknownPermission"),
		6 => Some("InvalidConfiguration"),
		7 => Some("TimeLockExceedsMaxAllowed"),
		8 => Some("InvalidProposalStatus"),
		9 => Some("StaleProposal"),
		10 => Some("AlreadyVoted"),
		11 => Some("HasNotApproved"),
		12 => Some("TimeLockNotReleased"),
		13 => Some("InvalidMessage"),
		14 => Some("InvalidNumberOfAccounts"),
		15 => Some("InvalidAccount"),
		16 => Some("ProtectedAccount"),
		17 => Some("InvalidActions"),
		18 => Some("MissingAccount"),
		19 => Some("NotSupportedForControlled"),
		20 => Some("NotSupportedForAutonomous"),
		21 => Some("MissingTreasury"),
		22 => Some("SpendingLimitExceeded"),
		23 => Some("InvalidDestination"),
		24 => Some("InvalidMint"),
		25 => Some("DecimalsMismatch"),
		26 => Some("InvalidPeriod"),
		27 => Some("InvalidLegacyMultisig"),
		28 => Some("InvalidConfigAuthority"),
