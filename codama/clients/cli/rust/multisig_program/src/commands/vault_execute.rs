...
use clap::Args;
use multisig_program_client::instructions::VaultExecute;
use multisig_program_client::instructions::VaultExecuteInstructionData;

use crate::context::CliContext;
use crate::context::CliError;

#[derive(Debug, Args)]
pub struct VaultExecuteArgs {
	...
	#[arg(long)]
	clock: String,
	/// The message's account keys, in message order. Accounts the message marks writable must also be writable in this instruction
	#[arg(long)]
	message_accounts: String,
}
