...
use clap::Args;
use multisig_program_client::instructions::ProposalCancel;
use multisig_program_client::instructions::ProposalCancelInstructionData;

use crate::context::CliContext;
use crate::context::CliError;

#[derive(Debug, Args)]
pub struct ProposalCancelArgs {
