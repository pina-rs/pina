...
//! Generated CLI for the `helloSolanaProgram` program.
...
/// Command-line interface for helloSolanaProgram
#[derive(Debug, Parser)]
#[command(name = "hello-solana-program-cli", version = env!("CARGO_PKG_VERSION"), propagate_version = true)]
struct Cli {
...
fn run(cli: Cli) -> Result<(), context::CliError> {
	let program_address = match &cli.program_id {
		...
		None => Pubkey::from_str_const("DCF5KBmtQ9ryDC7mQezKLwuJHem6coVUCmKkw37M9J4A"),
	};
