...
final class ProposalRevokeCommand extends Command<void> {
  ...
  @override
  String get name => 'proposal_revoke';

  @override
  String get description => "proposal_revoke";
  ...
  Future<void> run() async {
    ...
    final instruction = getProposalRevokeInstruction(
