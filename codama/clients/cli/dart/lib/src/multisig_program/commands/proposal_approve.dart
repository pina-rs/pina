...
final class ProposalApproveCommand extends Command<void> {
  ...
  @override
  String get name => 'proposal_approve';

  @override
  String get description => "proposal_approve";
  ...
  Future<void> run() async {
    ...
    final instruction = getProposalApproveInstruction(
