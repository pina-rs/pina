...
pub struct Migrate {
	...
	pub oracle_state: Option<solana_pubkey::Pubkey>,
}
...
impl Migrate {
	...
	pub fn instruction_with_remaining_accounts(
		...
		if let Some(oracle_state) = self.oracle_state {
			accounts.push(solana_instruction::AccountMeta::new(oracle_state, false));
		} else {
			accounts.push(solana_instruction::AccountMeta::new_readonly(
				crate::PROP_AMM_PROGRAM_ID,
				false,
