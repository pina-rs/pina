...
pub struct Migrate {
	...
	pub pool_state: Option<solana_pubkey::Pubkey>,
	pub position_state: Option<solana_pubkey::Pubkey>,
}
...
impl Migrate {
	...
	pub fn instruction_with_remaining_accounts(
		...
		if let Some(pool_state) = self.pool_state {
			accounts.push(solana_instruction::AccountMeta::new(pool_state, false));
		} else {
			accounts.push(solana_instruction::AccountMeta::new_readonly(
				crate::STAKING_REWARDS_PROGRAM_ID,
				false,
		...
		if let Some(position_state) = self.position_state {
			accounts.push(solana_instruction::AccountMeta::new(position_state, false));
		} else {
			accounts.push(solana_instruction::AccountMeta::new_readonly(
				crate::STAKING_REWARDS_PROGRAM_ID,
				false,
