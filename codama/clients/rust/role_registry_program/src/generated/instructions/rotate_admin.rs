...
impl RotateAdmin {
	pub fn new(admin: solana_pubkey::Pubkey, new_admin: solana_pubkey::Pubkey, registry_config: solana_pubkey::Pubkey) -> Self {
		Self {
			admin,
			new_admin,
			registry_config,
	...
	pub fn instruction_with_remaining_accounts(
		...
		accounts.push(solana_instruction::AccountMeta::new_readonly(self.new_admin, false));
...
impl RotateAdminInstructionData {
	pub fn new(configure: impl FnOnce(&mut RotateAdminInstructionWireZc)) -> Result<Self, solana_program_error::ProgramError> {
