...
impl CreateInstructionData {
	pub fn new(configure: impl FnOnce(&mut CreateInstructionWireZc)) -> Result<Self, solana_program_error::ProgramError> {
		let mut bytes = vec![0u8; core::mem::size_of::<CreateInstructionWireZc>()];
