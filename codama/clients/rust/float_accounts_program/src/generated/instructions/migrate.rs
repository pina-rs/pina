...
pub struct Migrate {
	...
	pub float_data_account: Option<solana_pubkey::Pubkey>,
}
	...
	pub fn instruction_with_remaining_accounts(
		...
		if let Some(payer) = self.payer {
			...
			accounts.push(solana_instruction::AccountMeta::new_readonly(
				crate::FLOAT_ACCOUNTS_PROGRAM_ID,
				false,
			));
		}
		...
		if let Some(float_data_account) = self.float_data_account {
