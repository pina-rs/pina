...
pub struct ProposalActivateInstructionData {
	bytes: Vec<u8>,
}

impl ProposalActivateInstructionData {
	pub fn new(
		configure: impl FnOnce(&mut ProposalActivateInstructionWireZc),
	) -> Result<Self, solana_program_error::ProgramError> {
		let mut bytes = vec![0u8; core::mem::size_of::<ProposalActivateInstructionWireZc>()];
