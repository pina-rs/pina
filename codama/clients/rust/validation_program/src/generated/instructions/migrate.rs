...
pub struct Migrate {
	...
	pub policy_state: Option<solana_pubkey::Pubkey>,
}
...
impl Migrate {
	...
	pub fn instruction_with_remaining_accounts(
		...
		if let Some(policy_state) = self.policy_state {
			accounts.push(solana_instruction::AccountMeta::new(policy_state, false));
		} else {
			accounts.push(solana_instruction::AccountMeta::new_readonly(
				crate::VALIDATION_PROGRAM_ID,
				false,
