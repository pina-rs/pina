...
impl Allocate {
	...
	pub fn instruction(&self, data: AllocateInstructionData) -> solana_instruction::Instruction {
...
impl AllocateInstructionData {
	pub fn new(
		configure: impl FnOnce(&mut AllocateInstructionWireZc),
	) -> Result<Self, solana_program_error::ProgramError> {
		let mut bytes = vec![0u8; core::mem::size_of::<AllocateInstructionWireZc>()];
