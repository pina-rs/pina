...
pub struct Migrate {
	...
	pub counter_state: Option<solana_pubkey::Pubkey>,
}
...
impl Migrate {
	...
	pub fn instruction_with_remaining_accounts(
		...
		if let Some(counter_state) = self.counter_state {
			accounts.push(solana_instruction::AccountMeta::new(counter_state, false));
		} else {
			accounts.push(solana_instruction::AccountMeta::new_readonly(
				crate::COUNTER_PROGRAM_ID,
				false,
