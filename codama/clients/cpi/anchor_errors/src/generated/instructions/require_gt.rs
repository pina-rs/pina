...
/// CPI call for the `require_gt` instruction.
#[derive(Clone, Copy, Debug)]
#[must_use = "the CPI has no effect until invoke or invoke_signed is called"]
pub struct RequireGt {
	/// Instruction arguments encoded and sent as CPI data for `require_gt`.
	pub instruction: RequireGtInstruction,
}

/// Instruction arguments for the `require_gt` CPI call.
#[derive(Clone, Copy, Debug, Default)]
pub struct RequireGtInstruction;

impl RequireGtInstruction {
