...
/// CPI call for the `resolve_challenge` instruction.
#[derive(Clone, Copy, Debug)]
#[must_use = "the CPI has no effect until invoke or invoke_signed is called"]
pub struct ResolveChallenge<'account> {
	...
	/// Instruction arguments encoded and sent as CPI data for `resolve_challenge`.
	pub ix: ResolveChallengeIx,
}

/// Instruction arguments for the `resolve_challenge` CPI call.
#[derive(Clone, Copy, Debug)]
...
impl<'account> ResolveChallenge<'account> {
