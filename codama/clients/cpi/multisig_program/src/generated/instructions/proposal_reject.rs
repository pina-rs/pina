...
/// CPI call for the `proposal_reject` instruction.
#[derive(Clone, Copy, Debug)]
#[must_use = "the CPI has no effect until invoke or invoke_signed is called"]
pub struct ProposalReject<'account> {
	...
	/// Instruction arguments encoded and sent as CPI data for `proposal_reject`.
	pub ix: ProposalRejectIx,
}

/// Instruction arguments for the `proposal_reject` CPI call.
...
impl<'account> ProposalReject<'account> {
