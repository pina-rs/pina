...
- Consumes the generated `prop-amm-program-cpi` crate for direct `.invoke()` and PDA-backed `.invoke_signed()` calls instead of maintaining handwritten CPI builders.
