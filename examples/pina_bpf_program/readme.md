...
- Consumes the generated `prop_amm_program_cpi` crate for direct `.invoke()` and PDA-backed `.invoke_signed()` calls instead of maintaining handwritten CPI builders.
