...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #457](https://github.com/pina-rs/pina/pull/457) · _Related issues:_ [#442](https://github.com/pina-rs/pina/issues/442), [#448](https://github.com/pina-rs/pina/issues/448), [#456](https://github.com/pina-rs/pina/issues/456), [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)

#### Generate every repository client with `pina generate`

_Packages:_ _pina_cli_

`pina generate` supersedes `pina codama generate`, which is removed. It discovers a project through its `pina.toml`, refreshes the IDL, and renders only the configured client ecosystems, so a repository generates its clients by running the command once per project instead of through a second command with its own path flags. The bundled skill reference documents the loop.
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #474](https://github.com/pina-rs/pina/pull/474) · _Related issues:_ [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)
...
The heap is off by default and opt-in twice over. Pina now depends on pinocchio with `default-features = false` and enables only `copy` and `sha2`, so pinocchio's `alloc` feature — and the `slice-cpi` code it gates — is no longer compiled into every Pina program. A new `alloc` feature forwards to it: enabling `pina/alloc` turns the heap on, and `nostd_entrypoint_alloc!` only exists when it is enabled. Calling the macro without the feature fails with a symbol named `ALLOC_FEATURE_REQUIRED_FOR_HEAP_ENTRYPOINT`, which spells out the remedy.
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #465](https://github.com/pina-rs/pina/pull/465) · _Closed issues:_ [#462](https://github.com/pina-rs/pina/issues/462) · _Related issues:_ [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)
...
_Packages:_ _pina_lints_, _pina_macros_
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #482](https://github.com/pina-rs/pina/pull/482) · _Related issues:_ [#289](https://github.com/pina-rs/pina/issues/289), [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494), [#802](https://github.com/pina-rs/pina/issues/802)
...
Move from the temporary `pinapod` 0.4.1 hold to 0.4.3, which brings the 0.4.2 commit-entry hardening at its intended compute-unit cost. 0.4.2 validates every generated compact buffer at `commit` before tails are relocated: a writer whose layout is corrupt fails closed before any offset or pointer work, and a preflight and commit length disagreement returns `InvalidLength` in release builds instead of relying on a debug assertion. By default, semantic defects such as non-UTF-8 tail bytes or out-of-range tags are caught at the next interpreting boundary rather than by `commit` itself; the `compact-commit-full-validation` feature restores the full walk at commit entry for consumers who prefer it. 0.4.3 keeps all of this and restores the compute-unit profile.
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #485](https://github.com/pina-rs/pina/pull/485) · _Related issues:_ [#38](https://github.com/pina-rs/pina/issues/38), [#39](https://github.com/pina-rs/pina/issues/39), [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #464](https://github.com/pina-rs/pina/pull/464) · _Related issues:_ [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)
...
_Packages:_ _pina_, _pina_codama_nodes_
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #489](https://github.com/pina-rs/pina/pull/489) · _Related issues:_ [#486](https://github.com/pina-rs/pina/issues/486), [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #461](https://github.com/pina-rs/pina/pull/461) · _Related issues:_ [#457](https://github.com/pina-rs/pina/issues/457), [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #481](https://github.com/pina-rs/pina/pull/481) · _Related issues:_ [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)
...
_Packages:_ _pina_cli_, _pina_codama_renderer_cli_
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #466](https://github.com/pina-rs/pina/pull/466) · _Related issues:_ [#462](https://github.com/pina-rs/pina/issues/462), [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)

- **pina_cli**: **Document the lint-driver origin overrides as operator-only.** `PINA_LINT_DRIVER_RELEASE`, `_REPO`, and `_BASE_URL` redirect the driver download and its checksum together, so they are a trusted-origin control rather than a convenience knob: whatever serves the override chooses which binary the CLI runs. The constants now say so, which is the documentation half of the 2026-09-21 audit's supply-chain finding; the version-pinned `npx` renderer fetches stay registry-trust-by-design. _Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #483](https://github.com/pina-rs/pina/pull/483) · _Related issues:_ [#472](https://github.com/pina-rs/pina/issues/472), [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)
...
_Packages:_ _pina_cli_renderer_, _pina_codama_renderer_cli_
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #486](https://github.com/pina-rs/pina/pull/486) · _Related issues:_ [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #488](https://github.com/pina-rs/pina/pull/488) · _Related issues:_ [#487](https://github.com/pina-rs/pina/issues/487), [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #487](https://github.com/pina-rs/pina/pull/487) · _Related issues:_ [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)
...
_Packages:_ _pina_, _pina_macros_, _pina_skill_
...
- **pina_cli**: **Stop the deploy stdin test racing a startup deadline.** The test that proves `solana` inherits a closed stdin polled the child against a three-second deadline, which Pina's `cargo metadata` project discovery exceeded on a loaded runner. It now waits for the marker the fake `solana` writes after reading EOF and keeps a thirty-second deadline purely as a hang bound. Test-only; no release note. _Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #469](https://github.com/pina-rs/pina/pull/469) · _Related issues:_ [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)

#### Close the shadow-PDA and discriminator-collision gaps

_Packages:_ _pina_cli_renderer_, _pina_codama_renderer_, _pina_cpi_renderer_, _pina_profile_, _pina_sdk_ids_, _pina_test_, _pina_codama_nodes_, _pina_codama_renderer_cpi_, _pina_codama_renderer_cli_, _pina_skill_
...
- **pina_cpi_renderer**: **Derive the scaffold release-line test from the crate version.** `scaffold_declares_pina_from_the_configured_source` computes the expected `pina` pin from `CARGO_PKG_VERSION` the same way `ScaffoldDependency::Published` renders it, so the assertion follows the crate's release line instead of holding a hard-coded `0.19` that the next version bump would leave behind. _Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #490](https://github.com/pina-rs/pina/pull/490) · _Related issues:_ [#459](https://github.com/pina-rs/pina/issues/459), [#491](https://github.com/pina-rs/pina/issues/491), [#492](https://github.com/pina-rs/pina/issues/492), [#494](https://github.com/pina-rs/pina/issues/494)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #317](https://github.com/pina-rs/pina/pull/317)

#### prefer guard-backed fixed-account loading

_Packages:_ _pina_, _pina_lints_
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #315](https://github.com/pina-rs/pina/pull/315)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #319](https://github.com/pina-rs/pina/pull/319)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #371](https://github.com/pina-rs/pina/pull/371)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #316](https://github.com/pina-rs/pina/pull/316)

#### ship the lint driver prebuilt with pina

_Packages:_ _pina_cli_, _pina_lints_

Stop building and installing the security-lint driver per user. The lints are statically linked into `pina_lint_driver`, which now ships prebuilt next to the `pina` CLI on every release target whose runner can host the pinned nightly, with npm platform packages carrying it the same way; `pina lint` resolves the driver beside its own executable and runs it directly. Targets without a matching runner ship CLI-only archives and `pina lint` fails there with guidance toward the prebuilt channels or `PINA_LINT_DRIVER_PATH`. The release pipeline builds the driver with the pinned nightly from `rust-toolchain.toml` on runners whose architecture matches the release target, because `rustc-dev` ships compiler libraries only for a toolchain's own host, so targets without a matching runner ship CLI-only archives.
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #336](https://github.com/pina-rs/pina/pull/336) · _Closed issues:_ [#334](https://github.com/pina-rs/pina/issues/334)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #324](https://github.com/pina-rs/pina/pull/324)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #335](https://github.com/pina-rs/pina/pull/335) · _Closed issues:_ [#65](https://github.com/pina-rs/pina/issues/65)
...
The proof must be a resolved Pina assertion against a const, immutable static, or unmodified alias of one whose failure is enforced with `?`, `unwrap()`, or `expect()` on every continuing path. Instruction inputs no longer count as trusted expected IDs. Failure-side `map_err()` and `inspect_err()` adapters are accepted before extraction, and the returned account value can be bound or chained. Discarded results, failure inspection, same-named methods, and one-branch checks no longer count. Success-side `map()`, `and_then()`, and `inspect()` adapters also do not establish proof because their callbacks can replace the validated binding before execution continues. Assignments, mutable borrows, `&mut self` method calls, and closures that may mutate a captured binding invalidate the earlier proof. Unverified CPI methods can no longer be stored as function values. Replace aliases, casts, containers, or closures with a direct method or UFCS call so the lint can see the exact target argument. A narrow lint allowance remains available for a reviewed abstraction that authenticates its target by another mechanism.
...
Before deliberate raw parsing, successfully call Pina's `assert_sysvar()` with the matching canonical `pina_sdk_ids::sysvar::<name>::ID` on every continuing path. A recognized canonical ID can now establish proof for a generically named binding such as `epoch_sysvar`; known names still require the matching ID. The returned account value can be bound or chained, and failure-side adapters are accepted before extraction. Place a narrow, reviewed lint allowance directly on the unchecked constructor. Discarded results, failure inspection, same-named methods or ID constants, one-branch checks, success-side callbacks, assignments, mutable borrows, `&mut self` method calls, and closures that may replace the asserted binding no longer establish proof.

_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #321](https://github.com/pina-rs/pina/pull/321)
...
_Packages:_ _pina_, _pina_abi_, _pina_cli_, _pina_macros_, _pina_codama_renderer_, _pina_cpi_renderer_, _pina_test_
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #329](https://github.com/pina-rs/pina/pull/329)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #318](https://github.com/pina-rs/pina/pull/318)

- **pina**: **Enforce emptiness in typed creation builders.** The four typed creation builders now reject targets whose storage holds any nonzero byte with `AccountAlreadyInitialized` before allocating. The deny-by-default `require_empty_before_init` lint is retired: remove it from `pina.toml` `[lints]` sections and drop manual pre-creation `assert_empty()` calls. Keep `assert_empty()` calls that guard raw `CreateAccount` allocations or token-account creation. _Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #332](https://github.com/pina-rs/pina/pull/332)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #320](https://github.com/pina-rs/pina/pull/320)

#### Reserve the framework Migrate instruction

_Packages:_ _pina_, _pina_abi_, _pina_cli_, _pina_macros_, _pina_codama_renderer_
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #369](https://github.com/pina-rs/pina/pull/369) · _Closed issues:_ [#338](https://github.com/pina-rs/pina/issues/338), [#339](https://github.com/pina-rs/pina/issues/339), [#340](https://github.com/pina-rs/pina/issues/340), [#348](https://github.com/pina-rs/pina/issues/348), [#356](https://github.com/pina-rs/pina/issues/356), [#357](https://github.com/pina-rs/pina/issues/357), [#358](https://github.com/pina-rs/pina/issues/358), [#359](https://github.com/pina-rs/pina/issues/359), [#360](https://github.com/pina-rs/pina/issues/360), [#361](https://github.com/pina-rs/pina/issues/361) · _Related issues:_ [#329](https://github.com/pina-rs/pina/issues/329), [#337](https://github.com/pina-rs/pina/issues/337), [#341](https://github.com/pina-rs/pina/issues/341), [#353](https://github.com/pina-rs/pina/issues/353), [#355](https://github.com/pina-rs/pina/issues/355), [#362](https://github.com/pina-rs/pina/issues/362)

- _Packages:_ _pina_cli_, _pina_lints_ **add the deny_unused_account_borrow_guards lint.** New warn-level lint flags account borrow guards bound to locals that are never read, with a machine-applicable multipart fix that discards the guard immediately (as a `?` statement, with the orphaned `drop(local);` removed in the same edit). Fix mode now attaches the lint driver through `RUSTC_WORKSPACE_WRAPPER` because the `cargo fix` proxy bypasses `RUSTC_WRAPPER` for primary units. _Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #314](https://github.com/pina-rs/pina/pull/314)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #313](https://github.com/pina-rs/pina/pull/313)

#### Add local profiler baseline comparison

_Packages:_ _pina_cli_, _pina_profile_
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #345](https://github.com/pina-rs/pina/pull/345) · _Closed issues:_ [#129](https://github.com/pina-rs/pina/issues/129) · _Related issues:_ [#125](https://github.com/pina-rs/pina/issues/125)
...
- **pina_test**: **Add Benchmark-Aware Program Tests.** Allow Surfpool program tests to resolve artifacts from a benchmark manifest and record simulated instruction compute units. _Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #322](https://github.com/pina-rs/pina/pull/322)

### Fixes

- _Packages:_ _pina_, _pina_macros_ **Preserve Declarative Validation at Mutation Boundaries.** Zero fixed, instruction, event, and compact-creation storage when initialization or application validation fails. Compact builders now accept the account's generated patch type, including wrappers that implement `PinaCompactPatch`, so structural and application validation cannot be bypassed by an unrelated safe `PinaPodPatch` implementation. Callers must propagate post-patch errors so Solana rolls back rejected bytes and any associated rent movement. _Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #328](https://github.com/pina-rs/pina/pull/328)
- _Packages:_ _pina_abi_, _pina_cli_, _pina_lints_, _pina_macros_, _pina_codama_renderer_, _pina_cpi_renderer_, _pina_test_ **Upgrade pinapod to 0.3.** Bump the workspace `pinapod` dependency from 0.2 to 0.3.1 and refresh the pina_fuzz lock files. Pina only re-exports and type-mentions the pinapod API, so no pina source changes were required, but the upgrade is breaking for downstream code that matches on `pina::PinaPodError` exhaustively: the error is now `#[non_exhaustive]` and requires a wildcard arm. `PodOption::raw_tag` returns `u64` so eight-byte tags cannot truncate, `PodOption` accepts eight-byte prefixes, and generated compact readers cache tail offsets for constant-time accessors. The wire format is unchanged. _Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #371](https://github.com/pina-rs/pina/pull/371)
...
_Packages:_ _pina_cli_, _pina_lints_, _pina_skill_
...
- **pina_cli**: **Enforce emptiness in typed creation builders.** The four typed creation builders now reject targets whose storage holds any nonzero byte with `AccountAlreadyInitialized` before allocating. The deny-by-default `require_empty_before_init` lint is retired: remove it from `pina.toml` `[lints]` sections and drop manual pre-creation `assert_empty()` calls. Keep `assert_empty()` calls that guard raw `CreateAccount` allocations or token-account creation. _Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #332](https://github.com/pina-rs/pina/pull/332)

#### Harden the generated CLIs and the renderer:

_Packages:_ _pina_cli_, _pina_cli_renderer_, _pina_codama_renderer_cli_
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #373](https://github.com/pina-rs/pina/pull/373) · _Related issues:_ [#335](https://github.com/pina-rs/pina/issues/335)
...
- **pina_lints**: **reject interior-mutable statics as trusted provenance.** The `require_program_check_before_cpi` lint no longer treats a const or immutable static whose type contains interior mutability as a compile-time-trusted expected ID. The declared type must be `Freeze` — no `UnsafeCell` anywhere in the type — so `static TARGET: Mutex<Pubkey>`, a raw `UnsafeCell` wrapper, a struct with an interior-mutable field, or a const of reference type aliasing an interior-mutable static falls through to the narrow allowance path instead of authenticating a dynamic CPI target. Consts, assoc consts, and immutable `Freeze` statics (for example plain `Address` or `[u8; 32]` values) remain accepted provenance. Code that deliberately passes a runtime-replaceable expected ID must use a narrowly scoped lint allowance with documented authentication. _Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #347](https://github.com/pina-rs/pina/pull/347) · _Closed issues:_ [#330](https://github.com/pina-rs/pina/issues/330) · _Related issues:_ [#321](https://github.com/pina-rs/pina/issues/321)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #346](https://github.com/pina-rs/pina/pull/346) · _Related issues:_ [#277](https://github.com/pina-rs/pina/issues/277)

- _Packages:_ _pina_cli_, _pina_skill_ **Preserve Declarative Validation at Mutation Boundaries.** Zero fixed, instruction, event, and compact-creation storage when initialization or application validation fails. Compact builders now accept the account's generated patch type, including wrappers that implement `PinaCompactPatch`, so structural and application validation cannot be bypassed by an unrelated safe `PinaPodPatch` implementation. Callers must propagate post-patch errors so Solana rolls back rejected bytes and any associated rent movement. _Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #328](https://github.com/pina-rs/pina/pull/328)

#### Correct CPI and sysvar validation guidance

_Packages:_ _pina_sdk_ids_
...
- **pina_skill**: **Enforce emptiness in typed creation builders.** The four typed creation builders now reject targets whose storage holds any nonzero byte with `AccountAlreadyInitialized` before allocating. The deny-by-default `require_empty_before_init` lint is retired: remove it from `pina.toml` `[lints]` sections and drop manual pre-creation `assert_empty()` calls. Keep `assert_empty()` calls that guard raw `CreateAccount` allocations or token-account creation. _Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #332](https://github.com/pina-rs/pina/pull/332)
...
_Packages:_ _pina_lints_, _pina_codama_renderer_
...
_Packages:_ _pina_, _pina_cli_, _pina_skill_
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #244](https://github.com/pina-rs/pina/pull/244)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #247](https://github.com/pina-rs/pina/pull/247) · _Related issues:_ [#244](https://github.com/pina-rs/pina/issues/244)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #248](https://github.com/pina-rs/pina/pull/248)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #251](https://github.com/pina-rs/pina/pull/251)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #258](https://github.com/pina-rs/pina/pull/258)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #250](https://github.com/pina-rs/pina/pull/250)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #253](https://github.com/pina-rs/pina/pull/253)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #255](https://github.com/pina-rs/pina/pull/255) · _Related issues:_ [#167](https://github.com/pina-rs/pina/issues/167)

#### Fix Windows Dylint Tool Archives

_Packages:_ _pina_cli_

Treat absolute Windows output paths as local files when packaging precompiled Dylint tools.

_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #260](https://github.com/pina-rs/pina/pull/260)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #254](https://github.com/pina-rs/pina/pull/254) · _Related issues:_ [#250](https://github.com/pina-rs/pina/issues/250)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #252](https://github.com/pina-rs/pina/pull/252) · _Related issues:_ [#167](https://github.com/pina-rs/pina/issues/167)

#### Restart the Unpublished v0.11.0 Release

_Packages:_ _pina_test_, _pina_codama_nodes_, _pina_cli_npm_, _pina_cli_darwin_arm64_, _pina_cli_darwin_x64_, _pina_cli_freebsd_x64_, _pina_cli_linux_arm64_gnu_, _pina_cli_linux_arm64_musl_, _pina_cli_linux_x64_gnu_, _pina_cli_linux_x64_musl_, _pina_cli_win32_arm64_msvc_, _pina_cli_win32_x64_msvc_

Restore the pending release state after the first v0.11.0 publish attempt stopped before any registry package was published.

_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #260](https://github.com/pina-rs/pina/pull/260)

## [0.10.0](https://github.com/pina-rs/pina/releases/tag/v0.10.0) (2026-08-28)
...
#### Add deterministic builds to `pina build`

_Packages:_ _pina_cli_, _pina_skill_

Add `pina build --verify` as an explicit Solana Verify 0.5.1 backend. The workflow stages only clean, Git-tracked inputs, preserves the canonical deployment output, and records a content-addressed artifact with Pina-computed build inputs and executable hash. Document installation, Docker and workspace prerequisites, security boundaries, automation output, and on-chain verification limits.

_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #233](https://github.com/pina-rs/pina/pull/233)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #234](https://github.com/pina-rs/pina/pull/234)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #236](https://github.com/pina-rs/pina/pull/236)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #237](https://github.com/pina-rs/pina/pull/237)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #232](https://github.com/pina-rs/pina/pull/232)
...
_Packages:_ _pina_cli_, _pina_test_, _pina_skill_
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #235](https://github.com/pina-rs/pina/pull/235)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #238](https://github.com/pina-rs/pina/pull/238) · _Related issues:_ [#233](https://github.com/pina-rs/pina/issues/233)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #239](https://github.com/pina-rs/pina/pull/239) · _Related issues:_ [#225](https://github.com/pina-rs/pina/issues/225)
...
_Owner:_ [@ifiokjr](https://github.com/ifiokjr) · _Review:_ [PR #240](https://github.com/pina-rs/pina/pull/240)
