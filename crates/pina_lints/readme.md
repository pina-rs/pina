...
- Callees from other crates are judged by their name and call-site behavior only. A `return helper()` whose helper cannot be analyzed counts as a failing branch, as the name rule did before.
