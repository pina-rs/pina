...
pub(crate) enum Commands {
	...
	///
	/// Discovers the nearest pina.toml or Cargo package, resolves a
	/// `pina_lint_driver` built for the project's active toolchain, and runs
	/// cargo check with the driver as `RUSTC_WORKSPACE_WRAPPER`. Lint levels
...
pub(crate) enum MigrationCommands {
	...
	Sync {
		...
		/// Write the conversion for an added field by hand instead of accepting
		/// a generated byte move or zero fill. Repeatable.
		#[arg(long = "manual", value_name = "FIELD")]
		manual: Vec<String>,
