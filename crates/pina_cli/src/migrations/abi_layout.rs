...
//!
//! [`generate`] renders a test module from the manifest. `pina migrations create`
...
pub fn generate(manifest: &MigrationManifest) -> String {
	...
	output.push_str(
		"//! Machine-checked ABI layout assertions.\n//!\n//! Generated by `pina migrations \
		 create`. Do not edit.\n//!\n//! Run `pina migrations create` after changing a schema; `pina \
...
/// checked-in snapshot, telling the developer to run `pina migrations create`.
///
