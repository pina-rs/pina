...
const _: () = if !(::core::mem::size_of::<InstructionDisc>() == ::core::mem::size_of::<u8>()) {
	{
		::core::panicking::panic_fmt(format_args!(
			"The size of the enum `InstructionDisc` must match the size of its primitive \
			 representation\n\t\t\t\t`u8`.",
		));
	}
};
...
impl Copy for InitializeZc where [u8; InstructionDisc::BYTES]: zeropod::ZcValidate {}
...
const _: () = if !(core::mem::align_of::<InitializeZc>() == 1) {
	::core::panicking::panic("assertion failed: core::mem::align_of::<InitializeZc>() == 1")
};
impl InitializeZc {
	#[inline(always)]
	...
	[u8; InstructionDisc::BYTES]: zeropod::ZcValidate,
{
	fn validate_ref(value: &Self) -> Result<(), zeropod::ZeroPodError> {
		<[u8; InstructionDisc::BYTES] as zeropod::ZcValidate>::validate_ref(&value.discriminator)?;
		Ok(())
	}
}
...
unsafe impl zeropod::ZcElem for InitializeZc where [u8; InstructionDisc::BYTES]: zeropod::ZcValidate {}
const _: fn() = || {
...
const _: () = if !(core::mem::align_of::<TransferZc>() == 1) {
	::core::panicking::panic("assertion failed: core::mem::align_of::<TransferZc>() == 1")
};
impl TransferZc {
	#[inline(always)]
	pub fn discriminator(&self) -> &[u8; InstructionDisc::BYTES] {
...
const _: () = if !(core::mem::align_of::<CustomTransferDataZc>() == 1) {
	::core::panicking::panic("assertion failed: core::mem::align_of::<CustomTransferDataZc>() == 1")
};
...
const _: () = if !(core::mem::align_of::<ComplexInstructionZc>() == 1) {
	::core::panicking::panic("assertion failed: core::mem::align_of::<ComplexInstructionZc>() == 1")
};
