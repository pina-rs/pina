...
const _: () = if !(::core::mem::size_of::<MyDiscriminator>()
    == ::core::mem::size_of::<u8>())
{
    {
        ::core::panicking::panic_fmt(
            format_args!(
                "The size of the enum `MyDiscriminator` must match the size of its primitive representation\n\t\t\t\t`u8`.",
            ),
        );
    }
};
    ...
    if !(::core::mem::size_of::<u16>() <= ::pina::MAX_DISCRIMINATOR_SPACE) {
        {
            ::core::panicking::panic_fmt(
                format_args!(
                    "A discriminator with primitive `u16` (2 bytes) exceeds `MAX_DISCRIMINATOR_SPACE` and cannot be safely used for zero-copy layouts. Supported primitives: `u8`, `u16`, `u32`, `u64`.",
                ),
            );
        }
    }
...
const _: () = if !(::core::mem::size_of::<U16Discriminator>()
    == ::core::mem::size_of::<u16>())
{
    {
        ::core::panicking::panic_fmt(
            format_args!(
                "The size of the enum `U16Discriminator` must match the size of its primitive representation\n\t\t\t\t`u16`.",
            ),
        );
    }
};
    ...
    if !(::core::mem::size_of::<u32>() <= ::pina::MAX_DISCRIMINATOR_SPACE) {
        {
            ::core::panicking::panic_fmt(
                format_args!(
                    "A discriminator with primitive `u32` (4 bytes) exceeds `MAX_DISCRIMINATOR_SPACE` and cannot be safely used for zero-copy layouts. Supported primitives: `u8`, `u16`, `u32`, `u64`.",
                ),
            );
        }
    }
...
const _: () = if !(::core::mem::size_of::<U32Discriminator>()
    == ::core::mem::size_of::<u32>())
{
    {
        ::core::panicking::panic_fmt(
            format_args!(
                "The size of the enum `U32Discriminator` must match the size of its primitive representation\n\t\t\t\t`u32`.",
            ),
        );
    }
};
    ...
    if !(::core::mem::size_of::<u64>() <= ::pina::MAX_DISCRIMINATOR_SPACE) {
        {
            ::core::panicking::panic_fmt(
                format_args!(
                    "A discriminator with primitive `u64` (8 bytes) exceeds `MAX_DISCRIMINATOR_SPACE` and cannot be safely used for zero-copy layouts. Supported primitives: `u8`, `u16`, `u32`, `u64`.",
                ),
            );
        }
    }
...
const _: () = if !(::core::mem::size_of::<U64Discriminator>()
    == ::core::mem::size_of::<u64>())
{
    {
        ::core::panicking::panic_fmt(
            format_args!(
                "The size of the enum `U64Discriminator` must match the size of its primitive representation\n\t\t\t\t`u64`.",
            ),
        );
    }
};
...
const _: () = if !(::core::mem::size_of::<FinalDiscriminator>()
    == ::core::mem::size_of::<u8>())
{
    {
        ::core::panicking::panic_fmt(
            format_args!(
                "The size of the enum `FinalDiscriminator` must match the size of its primitive representation\n\t\t\t\t`u8`.",
            ),
        );
    }
};
