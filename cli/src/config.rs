...
/// Load a signer from a URI. This may be a remote wallet, a file, or a seed
/// phrase passed in via command-line. Some URI schemes allow for specifying a
/// derivation path via a query parameter in the form of: `?path=x/y`.
