...
| L5 checked discriminator write      | `feat/checked-discriminator-write`       | `bc001962`             | `try_write_discriminator` reporting `DataTooShort`                                                                                                                  | 4 new tests including short/exact/oversized buffers                                                                                                                                      |
